...
void StateMachine::build_transition_table() {
    ...
    valid_transitions_ = {
        ...
        {S::STREAMING,          S::RECOVERING_DEVICE},
        {S::STALLED,            S::RECOVERING_DEVICE},
        {S::RECOVERING_DEVICE,  S::PROBING},
        {S::RECOVERING_DEVICE,  S::FATAL},
        {S::RECOVERING_DEVICE,  S::STOPPING},
